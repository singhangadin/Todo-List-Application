...
class SaveTaskViewModelTest {
    ...
    fun setupViewModel() {
        ...
        viewModel = SaveTaskViewModel(saveTaskUseCase, getTaskUseCase, testDispatcher)
    }
    ...
    fun testInitializationError() = runTest {
        ...
        assertEquals((results[2] as SaveTaskUIState.ShowMessage).message, R.string.message_task_not_found)
        job.cancel()
    }
    ...
    fun testTitleValidation() = runTest {
        ...
        assertTrue(results[2] is SaveTaskUIState.ShowMessage)
        assertEquals((results[2] as SaveTaskUIState.ShowMessage).message, R.string.message_error_title_empty)
        job.cancel()
    }
    ...
    fun testEmptyDateValidation() = runTest {
        ...
        assertTrue(results[2] is SaveTaskUIState.ShowMessage)
        assertEquals((results[2] as SaveTaskUIState.ShowMessage).message, R.string.message_error_data_empty)
        job.cancel()
    }
    ...
    fun testOldDateValidation() = runTest {
        ...
        assertTrue(results[2] is SaveTaskUIState.ShowMessage)
        assertEquals(viewModel.endDate.value.toString(), (results[2] as SaveTaskUIState.ShowMessage).message, R.string.message_error_date_limit)
        job.cancel()
    }
    ...
    fun testCreateTask() = runTest {
        ...
        assertTrue(results[2] is SaveTaskUIState.ShowMessage)
        assertEquals((results[2] as SaveTaskUIState.ShowMessage).message, R.string.message_task_saved)
    ...
    fun testCreateTaskErrorSaving() = runTest {
        ...
        // Show the success message
        assertTrue(results[2] is SaveTaskUIState.ShowMessage)
        assertEquals((results[2] as SaveTaskUIState.ShowMessage).message, R.string.message_error_saving_task)
        job.cancel()
    }
